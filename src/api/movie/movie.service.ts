 ...
 * 
 * 1. searchByText(query, page, language)
 *    - Busca películas por texto exacto usando el endpoint /search/movie.
 *    - Retorna la respuesta paginada de TMDB.
 * 
 * 2. searchByFilters(page, language, filters)
 *    - Busca películas usando filtros (géneros, rango de años, ordenamiento) sin texto.
 *    - Usa el endpoint /discover/movie de TMDB que permite filtrar directamente en el backend.
 * 
 * 3. searchByTextAndFilters(page, language, filters)
