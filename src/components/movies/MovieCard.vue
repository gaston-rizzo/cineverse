...
// ============================================================================
// HOVER MAGNÉTICO / TILT 3D DE LA TARJETA
// ============================================================================
...
function handleCardMove(e: MouseEvent) {
  ...
  // dimensiones y posición de la card
  const rect = card.getBoundingClientRect();

  // posición del cursor dentro de la card
  ...
  // cálculo de rotación según distancia al centro
  const rotateX = ((y - centerY) / centerY) * -9;
  const rotateY = ((x - centerX) / centerX) * 9;

  // aplicación del transform 3D
...
// Cuando el cursor abandona la tarjeta se restablece el estado original.

// Esto evita que la card quede inclinada cuando el mouse ya no está
// encima del elemento.

// Se restablecen todos los transforms a valores neutros.
