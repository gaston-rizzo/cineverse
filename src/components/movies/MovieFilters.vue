...
import { useMovieGenresQuery } from "@/composables/movies/useMoviesGenresQuery";

// Tipado del objeto de filtros
import type { MovieFilters } from "@/composables/movies/useMoviesFilters";
                ...
                <div v-show="openPanels[element as PanelId]" class="panel-body">
                  ...
                  <template v-if="element === 'list'">
                    ...
                    <Multiselect
                      class="multiselect"
                      :model-value="
                        listTypesOptions.find((o) => o.value === listType)
                      "
